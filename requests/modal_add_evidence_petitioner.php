<div class="modal fade" id="modal-add-evidence-petioner-request" tabindex="-1" style="display: none;" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle"> <i class="fas fa-arrow-trend-up"></i> Agregar Evidencia</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="form-add-evidence-petitioner">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"> <i class="fas fa-bookmark"></i> Guardar</button>
            </div>
            </form> 
        </div>
    </div>
