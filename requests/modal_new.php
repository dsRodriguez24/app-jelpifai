<div class="modal fade" id="modal-new-request" tabindex="-1" style="display: none;" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle"> <i class="fas fa-plus"></i> Nueva solicitud</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xl-4 col-12">
                        ...
                        <select name="metodo_remuneracion_id" onchange="handler_change_tipo_rem(this.value)" required class="form-select">
                            <?php
                            $tipos_remuneracion = [ 
                                "1" => "Puntos", 
                                "2" => "Favor", 
                    ...
                    <div class="col-12" id="div-puntos-ofrecidos">
                        <label for="puntos_ofrecidos" class="form-label">Puntos ofrecidos <b id="number-points">[0]</b> </label>
                        <input type="range" min="1" max="100" value="0" step="5" required name="puntos_ofrecidos" onchange="document.getElementById('number-points').innerHTML = `[${this.value}]` " style="width: 100%;">
                    </div>

                    <div class="col-12">
                        <label class="form-label">Archivos / Fotos</label>
                        <div class="d-flex gap-2 flex-wrap" id="preview-container"></div>

                        <div class="mt-2 d-flex gap-2">
                            <!-- Botón para seleccionar archivos -->
                            <input type="file" id="file-input" accept="image/*,application/pdf,.doc,.docx" multiple hidden>
                            ...
                            <button type="button" class="btn btn-outline-secondary btn-sm" onclick="take_photo()">
